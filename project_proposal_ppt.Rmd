...
```{r, fig.width=7, fig.height = 3, include = T}
merged.rossman.train %>%
  group_by(StoreType) %>%
...
The distance of each store from a nearest competing store has been provided in the dataset. Lets check the distribution after log transformation of this variable.
